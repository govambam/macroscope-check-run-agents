#!/usr/bin/env bash
# ── Vendored into the macroscope-check-run-agents skill ──────────────────────
# Source of truth: https://github.com/govambam/pr-backtest-script
# Snapshot of commit 4ca1aee (main). Bundled here so the skill is
# self-contained — anyone reviewing this one repo can read exactly what runs,
# with no runtime download. Re-sync this file if the upstream script changes.
# ─────────────────────────────────────────────────────────────────────────────
#
